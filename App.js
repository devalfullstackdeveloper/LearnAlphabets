...
const SelectScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.mainView}>
      <ImageBackground source={require('./assets/backgroundSelectScreen.jpg')} style={styles.image} >
...
const Numbers = ({ navigation }) => {
  ...
  return (
    <View style={{ flex: 1, }}>
      <ImageBackground source={require('./assets/backgroundListing.jpg')} style={styles.image} >
